...
const contacts = [
  {
    Icon: GithubIcon,
    alt: "github icon",
    link: "https://github.com/MeganSorenson",
  },
  {
    Icon: LinkedinIcon,
    alt: "linkedin icon",
    link: "https://www.linkedin.com/in/megsorenson/",
  },
  {
    Icon: EnvelopeIcon,
    alt: "envelope icon",
    link: "mailto:megansage01@gmail.com?subject=Website",
  },
];
    ...
    <footer className="py-8 flex">
      <div className="max-w-5xl px-8 mx-auto flex flex-col justify-center md:flex-row">
        <a
          ...
          href="https://github.com/MeganSorenson"
        >
          Megan Sorenson - Student @ University of Alberta
        </a>
